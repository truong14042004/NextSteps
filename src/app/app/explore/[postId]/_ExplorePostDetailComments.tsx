    ...
    <div className="space-y-4">
      {comments.length === 0 ? (
        ...
        comments.map(comment => (
          <div key={comment.id} className="flex items-start justify-between gap-3 rounded-lg bg-muted/40 p-3">
      ...
      {canComment && (
        <div className="flex gap-2">
          <Input
            ...
            maxLength={1200}
          />
          <Button type="button" size="icon" disabled={isPending || content.trim().length === 0} onClick={submitComment}>
