...
export const env = createEnv({
  server: {
    ...
    AUTH_SESSION_SECRET: z.string().min(32).default("replace-this-with-at-least-32-characters-session"),
    AUTH_OTP_SECRET: z.string().min(32).default("replace-this-with-at-least-32-characters-otp"),
